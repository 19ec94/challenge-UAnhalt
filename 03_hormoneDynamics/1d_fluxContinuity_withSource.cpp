...
const int TESTCASE = 3; // Figure 4.7(a, b)
double T_FINAL = 0.1;
double CFL = 0.1;
double G_L = 0.5;
double G_R = 1.0;
...
int main() {
  if (TESTCASE == 1) {
    ...
    T_FINAL = 0.0666; // Figure 4.7(b)
    CFL = 0.02; 
    G_L = 3.0; //Figure 4.7(b)
    G_R = 1.0; // Figure 4.7(b)
    LAMBDA_L = 1.0; //Figure 4.7(b)
    LAMBDA_R = 0.0; //Figure 4.7(b)
  }
